...
void json_parse_object(struct json_parse_state_s *state, int is_global_object,
  ...
  size_t elements = 0;
  int allow_comma = 0;
  struct json_object_element_s *previous = nullptr;
  ...
  while (state->offset < size) {
    struct json_object_element_s *element = nullptr;
    struct json_string_s *string = nullptr;
    struct json_value_s *value = nullptr;
...
void json_parse_array(struct json_parse_state_s *state,
  ...
  size_t elements = 0;
  int allow_comma = 0;
  struct json_array_element_s *previous = nullptr;
  ...
  do {
    struct json_array_element_s *element = nullptr;
    struct json_value_s *value = nullptr;
...
struct json_value_s *json_parse(const void *src, size_t src_size) {
  return json_parse_ex(src, src_size, json_parse_flags_default, nullptr,
                       nullptr, nullptr);
}
...
struct json_value_s *json_extract_value(const struct json_value_s *value) {
  return json_extract_value_ex(value, nullptr, nullptr);
}
