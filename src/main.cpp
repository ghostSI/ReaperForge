...
int main(int argc, char* argv[])
{
  ...
  Global::window = SDL_CreateWindow("ReaperForge", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, Global::windowWidth, Global::windowHeight, SDL_WINDOW_RESIZABLE | SDL_WINDOW_OPENGL);
