...
static void psarcTOCTest() {
    ...
    static u8 expectedTOCPlainText[] = {
            ...
            5, 51, 2, 166, 3, 60, 2, 218, 2, 47, 149, 247,
            26, 86, 246, 47, 129, 216, 204, 119, 176, 190, 144, 173,
            199, 119, 79, 219, 173, 89, 117, 63, 131, 212, 193, 102,
            5, 189, 52, 116, 236, 7, 211, 90, 54, 148, 69, 77,
            177, 51, 235, 83, 188, 215, 83, 33, 94, 176, 215, 207,
            166, 196, 221, 180, 196, 146, 194, 103, 155, 53, 15, 245,
            24, 182, 100, 145, 102, 253, 234, 167, 220, 188, 105, 237,
            155, 53, 15, 245, 24, 182, 100, 145, 102, 253, 234, 167,
            220, 188, 105, 237, 155, 53, 15, 245, 24, 182, 100, 145,
            102, 253, 234, 167, 220, 188, 105, 237, 155, 53, 15, 245,
            24, 182, 100, 145, 102, 253, 234, 167, 220, 188, 105, 237,
            155, 53, 15, 245, 24, 182, 100, 145, 102, 253, 234, 167,
            220, 188, 105, 237, 155, 53, 15, 245, 24, 182, 100, 145,
            102, 253, 234, 167, 220, 188, 105, 237, 155, 53, 15, 245,
    ...
    ASSERT(sizeof(expectedTOCPlainText) == psarcInfo.data.toc.size());

    for (u64 i= 0; i < psarcInfo.data.toc.size(); ++i)
    {
        ASSERT(expectedTOCPlainText[i] == psarcInfo.data.toc[i]);
    }
}
