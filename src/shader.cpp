...
void Shader::init()
{
  ...
  shaderPrograms.push_back(compileShader(Data::Shader::defaultWorldVert, Data::Shader::anchorWorld));
  shaderPrograms.push_back(compileShader(Data::Shader::defaultWorldVert, Data::Shader::chordBoxWorld));
}
